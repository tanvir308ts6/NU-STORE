        ...
        <v-layout column class="mx-5">
          ...
          <v-flex xs12>
            <v-card class="px-3 ma-3 CSP_BoarderStyle" color="#FAFAFA">
              <v-layout row wrap align-center class="py-3">
                ...
                ></v-checkbox>
                <!-- <v-checkbox
                  v-model="searchParam.incourse_status"
                  label="In-course "
                  class="mt-5 mr-2 ml-2"
                  color="indigo darken-3"
                  @change="incourseStatus($event)"
                ></v-checkbox>-->
              </v-layout>
            </v-card>
          </v-flex>
          <v-flex xs12 sm12 md12 class="my-3">
            <v-layout justify-center row fill-height align-center>
              <v-btn outline round large @click="searchOverallWantingList">
      ...
      <v-card color="white">
        <v-layout row>
          ...
          <v-btn medium color="primary" class="white--text" @click="generateReport()">
            <v-icon left dark>arrow_downward</v-icon>Overall Wanting List ( Download Table Data )
          </v-btn>
        </v-layout>
      </v-card>
...
export default {
  ...
  methods: {
    ...
    incourseStatus(val) {
      if (val == true) {
        this.searchParam.incourse_status = 1;
      } else {
        this.searchParam.incourse_status = 0;
      }
    },
