    ...
    <v-card class="ma-4">
      <v-container fluid>
        <div style="background-color: #dcedc8">
          ...
          <rescrutinyResultSummary></rescrutinyResultSummary>
                ...
                <template v-slot:label>
                  <div>
                    <span class="black--text" style="font-size: 1.4em"
                      >I have checked Rescrutiny Result Summary</span
                    >
                  </div>
                </template>
              </v-checkbox>
                    ...
                    <v-card style="height: 80px" flat>
                      ...
                      >
                        <v-chip
                          ...
                          "
                        >
                          <strong :class="getclass(current_user.id == '8')">Programmer/Sr. Programmer</strong>
                        </v-chip>
                        ...
                        <v-chip
                          ...
                          color="primary"
                        >
                          <strong :class="getclass(current_user.id == '22')">System Analyst/Sr. System Analyst</strong>
                        </v-chip>
                        <v-chip color="white" small>
                          <v-icon color="primary" large
                            >keyboard_arrow_right</v-icon
                        ...
                        <v-chip
                          style="font-size: 1em"
                          label
                          :outline="current_user.id != '9'"
                          color="primary"
                        >
                          <strong :class="getclass(current_user.id == '9')">ICT Director</strong>
                        </v-chip>
                        <v-chip color="white" small>
                          <v-icon color="primary" large
                            >keyboard_arrow_right</v-icon
                        ...
                        <v-chip
                          ...
                          "
                        >
                          <strong :class="getclass(current_user.id == '10')">Controller of Examination</strong>
                        </v-chip>
                        <v-chip color="white" small>
                          <v-icon color="primary" large
                            >keyboard_arrow_right</v-icon
                        ...
                        <v-chip
                          style="font-size: 1em"
                          label
                          :outline="current_user.id != '11'"
                          color="primary"
                        >
                          <strong :class="getclass(current_user.id === '11')">Vice Chancellor</strong>
                        </v-chip>
                      </v-flex>
                      <v-flex
...
export default {
  ...
  components: { textEditor, rescrutinyResultSummary },
  $_veeValidate: {
    validator: "new",
  },
  data: () => ({
  ...
  created() {
    ...
    this.hideCheck = true;
    this.searchParam.type = 2; //on create type = rescrutiny set to searchparam
  ...
  methods: {
    ...
    publishNote() {
      ...
      formData.append("comment", this.$refs.texteditor.delta); //get note from texteditor
      formData.append("type", 2); // type = rescrutiny send
      ...
      this.$root
        .$confirm(
          "Are you sure that you've checked the re-scrutiny result & want to Publish?"
        )
        .then((confirm) => {
          if (confirm) {
            this.$store
    ...
    sendNote() {
      ...
      this.$root
        .$confirm(
          "Are you sure that you've checked the re-scrutiny result & want to send Note?"
        )
        .then((confirm) => {
          if (confirm) {
            this.$store
