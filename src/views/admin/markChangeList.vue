          ...
          >
            <section slot="pdf-content">
              ...
              <div class="row">
                <div class="col-12">
                  <table
                    style="font-family:Calibri,sans-serif;border: 1px solid red;width: 93%;border-collapse:collapse;border:none;margin-left:0.5cm;margin-top:1.5cm;"
                  >
                    <tbody>
              ...
              <table
                style="font-size:15px;font-family:Calibri,sans-serif;border-color: black; background-color: white; width: 765px;margin-top: 1cm; margin-left: 0.3cm; margin-right: 1.5cm; height: 78px;"
                border="1"
                cellspacing="0"
                cellpadding="0"
              >
                <thead>
                  <tr style="background-color:white;">
                    <td style="width: 33.2px; text-align:center;">
                      <strong>SL.</strong>
                    </td>
                    <td style="width: 152.4px; text-align:center;">
                      <strong>Center</strong>
                    </td>
                    <td style="width: 105.2px; text-align:center;">
                    ...
                    <td style="width: 94.8px; text-align:center;">
                      <strong>Student Capacity</strong>
                    </td>
                    <td style="width: 99.6px; text-align:center;">
                      <strong>Responsible Person</strong>
                    </td>
                  </tr>
                </thead>
                <tbody v-for="(item, index) in getCenterList" :key="item.college_code">
                  <tr style="background-color:white;">
                    <td style="width: 33.2px; text-align:center;">{{ index + 1 }}</td>
                    <td style="width: 152.4px; text-align:center;">{{ item.center_name }}</td>
                    <td style="width: 105.2px; text-align:center;">{{ item.address }}</td>
                    <td style="width: 102px; text-align:center;">{{ item.mobile }}</td>
                    <td style="width: 162px; text-align:center;">{{ item.email }}</td>
                    <td style="width: 94.8px;text-align:center;">{{ item.student_capacity }}</td>
                    <td style="width: 99.6px; text-align:center;">{{ item.responsible_person }}</td>
                  </tr>
                </tbody>
              </table>
            </section>
...
<script>
import formDialog from "@/components/admin/enterChangeMark.vue";
