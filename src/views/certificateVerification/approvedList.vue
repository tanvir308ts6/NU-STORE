    ...
    <div>
      ...
      <v-container fluid>
        ...
        <v-card color="white">
          <v-layout row>
            <v-card flat>
              <v-card-text class="title">Approved List</v-card-text>
            </v-card>
...
<script>
import studentDetails from "@/components/service/certificateVerification/statusApprovedDetails.vue";
...
export default {
  ...
  methods: {
    ...
    getCvListFromApi() {
      this.setLimit();
      this.loading = true;
      this.searchParam.status = "approved";
      this.$store
