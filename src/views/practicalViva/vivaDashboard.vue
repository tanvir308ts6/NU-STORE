  ...
  <v-container fluid>
          ...
          <v-flex xs12>
            ...
            <v-flex xs12 sm12 md12 style="margin-top:5px;margin-bottom:8px;">
              <v-layout justify-center row fill-height align-center>
                <v-btn outline round large @click="getVivaCandSummary">
        ...
        <v-layout row>
          <v-card flat>
            <v-badge left overlap>
              ...
              <v-card-text class="title">Viva Dashboard</v-card-text>
            </v-badge>
          </v-card>
    ...
    <v-container fluid class="mt-3">
      ...
      <v-data-table
        class="elevation-1"
        :headers="headers1"
        :items="getVivaCandSummaryDataList"
        :loading="loading"
...
export default {
  components: { vivaSummary, practicalSummary },
  ...
  data() {
    return {
      ...
      headers1: [
        ...
        {
          text: "Total Practical Student",
          value: "completed_count",
          align: "center",
        },
        {
          text: "Total Viva Student",
          value: "completed_count",
          align: "center",
        },
      ],
  ...
  computed: {
    getVivaDashDataList() {
      return this.$store.getters.getVivaDashDataList;
    },
    getVivaCandSummaryDataList() {
      return this.$store.getters.getVivaCandSummaryDataList;
    },
  },
  methods: {
    setLimit() {
    ...
    getDashboardData() {
      ...
      this.setLimit();
      this.$store
        .dispatch("searchVivaDashboardData", this.searchParam)
        .then((data) => {
          this.loading = false;
    ...
    getVivaCandSummary() {
      ...
      this.setLimit1();
      this.$store
        .dispatch("getVivaCanditateListSummary", this.searchParam)
        .then((data) => {
          this.loading = false;
          this.sl_count = data.from;
    ...
    generateReportCollege() {
      ...
      this.$store.dispatch("exportVivaCandSummaryList", this.searchParam);
    },
