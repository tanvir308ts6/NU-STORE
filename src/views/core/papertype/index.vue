    ...
    <div>
      <v-container fluid>
        <v-card color="white">
          ...
          <v-layout row>
            <v-card flat>
              <v-card-text class="title">Paper Type</v-card-text>
            </v-card>
...
<script>
import formDialog from "@/components/core/paperType/paperTypeForm.vue";
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Paper", align: "center", value: "college_type" },
