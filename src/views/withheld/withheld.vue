    ...
    <v-dialog v-model="formDialog" fullscreen hide-overlay transition="dialog-bottom-transition">
      <v-card>
        <v-toolbar dark color="primary">
          ...
          <v-toolbar-title >Report Entry Form</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
        ...
        <v-layout row>
          <v-card flat>
            <v-badge left overlap color="transparent">
              ...
              <v-card-text class="title" >Reported List</v-card-text>
            </v-badge>
          </v-card>
...
import withheldEntryForm from "@/components/withheld/withheldEntryForm";
