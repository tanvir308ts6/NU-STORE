        ...
        <v-toolbar-items>
          <v-card flat color="light-blue darken-4" class="mr-5">
            <v-layout row fill-height align-center justify-center>
              Current Center &nbsp; :&nbsp;
              {{ currentItem.center_code }} - {{ currentItem.center_name }}
            </v-layout>
          </v-card>
    ...
    <v-layout>
      ...
      <v-flex xs6 class="mr-5">
        <v-layout align-center justify-center row fill-height>
          ...
          <v-btn style="margin-left: -25em" @click="downLoadrollDescriptive()"
            >DOWNLOAD Descriptive Roll Sheet</v-btn
          >
          <div v-if="!ifCenterUser">
            <v-btn style="margin-left: -36em" @click="downloadAdmit()"
              >DOWNLOAD Admit card</v-btn
            >
          </div>
          <!-- downloadAdmit -->
        </v-layout>
            ...
            <v-badge left overlap>
              ...
              <v-card-text class="title"
                ><router-link
                  ...
                  tag="button"
                  to="/center/center-dashboard"
                  >Examinee Count By Course</router-link
                >
                <router-link
                  v-if="isNotInConfig2()"
                  class="btn btn-fill btn-default"
                  tag="button"
                  to="/admit-card-dd"
                  >Admit Card By Course</router-link
                ></v-card-text
              >
            </v-badge>
          </v-card>
        ...
        <template v-slot:items="props">
          ...
          <td class="text-xs" style="padding: 0 0px; !important">
            <v-chip color="transparent"
              ...
              {{ props.item.subject_name }}</v-chip
            >
          </td>
          ...
          <!-- <td>
            <v-btn @click="downLoadrollDescriptive(props.item)">Descriptive roll Sheet</v-btn>
          </td>-->
          <!-- <td>
            <v-btn @click="downloadAttendanceSheet(props.item)">DOWNLOAD attendance Sheet</v-btn>
          </td>-->
