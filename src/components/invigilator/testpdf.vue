        ...
        <div class="row">
          <div class="col-12">
            ...
            >
              <thead>
                <tr style="background-color:white;">
                  <th style=" width: 35%">Invigilator Name</th>
                  <th style=" width: 20%">Email</th>
                  <th style=" width: 20%">Mobile</th>
                </tr>
              </thead>
              <tbody v-for="item in getSchema" :key="item.invigilator_id">
                <tr v-if="item.app_access == 1" style="background-color:white;">
                  <td style=" width: 35%">{{ item.invigilator_name }}..</td>
                  <td style=" width: 20%">{{ item.email }}</td>
                  <td style=" width: 20%">{{ item.mobile }}</td>
                </tr>
              </tbody>
            </table>
          </div>
