<template>
  <v-container fluid>
      ...
      <v-card color="white">
        <v-layout row>
          ...
          <v-layout justify-center row fill-height align-center>
            <v-btn flat round medium>
              Flow: (
              {{ getPracticalWantListByStd_current.center_name }}
              <v-icon dark class="mx-2">arrow_right_alt</v-icon>
              {{ getPracticalWantListByStd_current.college_name }}
              <v-icon dark class="mx-2">arrow_right_alt</v-icon>
              {{ getPracticalWantListByStd_current.subject_name }}
              <v-icon dark class="mx-2">arrow_right_alt</v-icon>
              {{ getPracticalWantListByStd_current.paper_name }} )
            </v-btn>
            <v-btn
              medium
              color="primary"
        ...
        >
          <section slot="pdf-content">
            ...
            >
              ...
              <tbody
                v-for="(item, index) in getPracticalWantListByStd"
                :key="item.index"
              >
                <tr style="background-color:white;">
                  <td
    ...
    <pre>{{searchParam}} </pre>
    <pre>::::{{getPracticalWantListByStd_current}} </pre>-->
  </v-container>
</template>
...
export default {
  ...
  computed: {
    ...
    getPracticalWantListByStd_current() {
      return this.$store.getters.getPracticalWantListByStd_current;
    },
  },
  methods: {
    generateReport() {
  ...
  watch: {
    ...
    // },
    getPracticalWantListByStd_current(val) {
