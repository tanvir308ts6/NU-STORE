                      ...
                      <template>
                        ...
                        <v-container fluid grid-list-xl>
                          <v-layout row wrap>
                            ...
                            <v-flex md4>
                              <v-text-field
                                v-model="getSchema.second_year_exam_code"
                                label="Second Year Exam COde"
                                disabled
                              ></v-text-field>
                            </v-flex>
                          </v-layout>
...
-->
                            <v-flex md4>
                              <v-select
                                v-model="getSchema.irregular_year"
...
export default {
  ...
  computed: {
    getSchema() {
      return this.$store.getters.honoursThirdYear;
    },
    getSchemaSession() {
  ...
  methods: {
    save() {
      ...
      if (!isEmpty) {
        this.$store
          .dispatch("generateProbableHnsPartThree", data)
          .then(function(data) {
            try {
              self.close();
